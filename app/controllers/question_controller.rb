class QuestionController < ApplicationController
  ...
  def mypage
    ...
    @play = PlayQuest.find_by(user_id: @current_user.id, clear: false, deleted: false)
    if @play
  ...
  def show
    ...
    @user = @quest.user
    @play_quest = PlayQuest.find_by(user_id: @current_user.id, clear: false, deleted: false)
  end
  def create
